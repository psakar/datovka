...
/* ========================================================================= */
{
	...
	if (1 == messageDb.messageState(dmID)) {
		/*
		 * TODO -- Update message envelope when the previous state
		...
		qDebug() << "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
		qDebug() << "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
		qDebug() << "XXX Must update whole message envelope. XXX";
		qDebug() << "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
		qDebug() << "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
		qDebug() << "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
...
qdatovka_error Worker::downloadMessage(const QModelIndex &acntTopIdx,
    const QString &dmId, bool signedMsg, enum MessageDirection msgDirect,
