...
namespace Gov {
	...
	/*!
	 * GOV SZR service
	 * Name: Žádost o výpis údajů z Registru obyvatel
	 * DS: 4h8cxph - Automat ZR (Správa základních registrů)
	 * XML: zrds.xml - není třeba nic v xml měnit.
	 * Source DS type: FO
	 */
	class SrvcSzrRobVu : public Service {
		Q_DECLARE_TR_FUNCTIONS(SrvcSzrRobVu)
