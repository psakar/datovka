...
"<d:root xmlns:d=\"http://software602.cz/sample\" ancestor_id=\"\" "
  ...
  "register=\"261\" retry=\"0\" seq=\"\" templateVersion_id=\"\" url=\"\" "
...
const QString &Gov::SrvcMvIrVp::fullName(void) const
{
	static const QString fullName(tr("Printout from the insolvency register"));
	// "Výpis z insolvenčního rejstříku"
	return fullName;
}

const QString &Gov::SrvcMvIrVp::instituteName(void) const
{
	static const QString instituteName(GOV_MV_FULL_NAME);
	return instituteName;
}

const QString &Gov::SrvcMvIrVp::boxId(void) const
{
	static const QString boxId(GOV_MV_DB_ID);
	return boxId;
}

const QString &Gov::SrvcMvIrVp::dmAnnotation(void) const
{
	static const QString dmAnnotation("CzechPOINT@home - Výpis z insolvenčního rejstříku");
	return dmAnnotation;
}

const QString &Gov::SrvcMvIrVp::dmSenderIdent(void) const
{
	static const QString dmSenderIdent("CzechPOINT@home - 261");
	return dmSenderIdent;
}

const QString &Gov::SrvcMvIrVp::dmFileDescr(void) const
{
	static const QString dmFileDescr(GOV_MV_XML_FILE_NAME);
	return dmFileDescr;
}

bool Gov::SrvcMvIrVp::canSend(enum Isds::Type::DbType dbType) const
{
	switch (dbType) {
