...
"<d:root xmlns:d=\"http://software602.cz/sample\" ancestor_id=\"\" "
  ...
  "register=\"251\" retry=\"0\" seq=\"\" templateVersion_id=\"\" url=\"\" "
  "url_release=\"\" user_name=\"\" version=\"9.6\">""\n"
"  <d:gw_sn/>""\n"
"  <d:gw_form_name/>""\n"
...
"  </d:referent>""\n"
"  <d:vyhledavaci_udaje>""\n"
"    <d:ic typ_vypisu=\"2\">xIC_SUBJECT</d:ic>""\n"
"    <d:ku kod=\"\"/>""\n"
"    <d:lv/>""\n"
"    <d:ir>""\n"
"      <d:ic/>""\n"
...
"    <d:dic/>""\n"
"  </d:evidencni_udaje_hk>""\n"
"  <p:dmDm xmlns:p=\"http://isds.czechpoint.cz/v20/MessageCreate\">""\n"
"    <p:MessageCreate>""\n"
"      <p:dmEnvelope>""\n"
"        <p:dmSenderIdent/>""\n"
"        <p:dbIDRecipient>xhzkdqv</p:dbIDRecipient>""\n"
"        <p:dmAnnotation/>""\n"
"      </p:dmEnvelope>""\n"
"      <p:dmFiles>""\n"
"        <p:dmFile dmMimeType=\"text/xml\" dmFileMetaType=\"main\" "
          "dmFileGuid=\"\" dmUpFileGuid=\"\" dmFileDescr=\"czpathome.xml\" "
          "dmFormat=\"\">""\n"
"          <p:dmEncodedContent file_size=\"\"/>""\n"
"        </p:dmFile>""\n"
"      </p:dmFiles>""\n"
"    </p:MessageCreate>""\n"
"    <p:MessageCreateResponse>""\n"
"      <p:dmID/>""\n"
"      <p:dmStatus>""\n"
"        <p:dmStatusCode/>""\n"
"        <p:dmStatusMessage/>""\n"
...
"    </p:MessageCreateResponse>""\n"
"  </p:dmDm>""\n"
"  <d:nerelevantni_pomocne>""\n"
"    <d:krok>vyplneni</d:krok>""\n"
"    <d:ukaz_odeslani>0</d:ukaz_odeslani>""\n"
"    <d:vysledek_odeslani/>""\n"
"    <d:relevance_DZ>0</d:relevance_DZ>""\n"
"    <d:relevance_NP>0</d:relevance_NP>""\n"
"    <d:dnesni_datum/>""\n"
"    <d:kontrola_1>1</d:kontrola_1>""\n"
"    <d:typ_ic_9>0</d:typ_ic_9>""\n"
"    <d:prijemce>Automat CzP</d:prijemce>""\n"
"  </d:nerelevantni_pomocne>""\n"
"</d:root>";
...
class MvVrVpData {
	Q_DECLARE_TR_FUNCTIONS(MvVrVpData)
...
QList<Gov::FormField> MvVrVpData::allFields(void) const
{
...
Gov::SrvcMvVrVp::SrvcMvVrVp(void)
    : Service()
{
	m_formFields = MvVrVpData().allFields();
}
...
const QString &Gov::SrvcMvVrVp::fullName(void) const
{
	static const QString fullName(tr("Printout from the public register"));
	// "Výpis z veřejného rejstříku"
	return fullName;
}

const QString &Gov::SrvcMvVrVp::instituteName(void) const
{
	static const QString instituteName(GOV_MV_FULL_NAME);
	return instituteName;
}

const QString &Gov::SrvcMvVrVp::boxId(void) const
{
	static const QString boxId(GOV_MV_DB_ID);
	return boxId;
}

const QString &Gov::SrvcMvVrVp::dmAnnotation(void) const
{
	static const QString dmAnnotation("CzechPOINT@home - Výpis z Veřejného rejstříku");
	return dmAnnotation;
}

const QString &Gov::SrvcMvVrVp::dmSenderIdent(void) const
{
	static const QString dmSenderIdent("CzechPOINT@home - 251");
	return dmSenderIdent;
}

const QString &Gov::SrvcMvVrVp::dmFileDescr(void) const
{
	static const QString dmFileDescr(GOV_MV_XML_FILE_NAME);
	return dmFileDescr;
}

bool Gov::SrvcMvVrVp::canSend(enum Isds::Type::DbType dbType) const
{
	switch (dbType) {
...
bool Gov::SrvcMvVrVp::setFieldVal(const QString &key, const QString &val)
{
	return Service::setFieldVal(key, val);
}

bool Gov::SrvcMvVrVp::setOwnerInfoFields(const Isds::DbOwnerInfo &dbOwnerInfo)
{
...
QByteArray Gov::SrvcMvVrVp::binaryXmlContent(void) const
{
	...
	xml.replace("xIC_SUBJECT", fieldVal(IC_KEY));
	return xml.toUtf8();
}
