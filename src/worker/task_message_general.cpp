...
qdatovka_error MessageTaskGeneral::downloadMessageList(const QString &userName,
...
bool MessageTaskGeneral::downloadMessageState(enum MessageDirection msgDirect,
...
qdatovka_error MessageTaskGeneral::updateMessageState(
    enum MessageDirection msgDirect, MessageDbSet &dbSet,
    const struct isds_envelope *envel)
{
	if (NULL == envel) {
